...
$database = new Connection();
  ...
  $query = "  SELECT tickets.id, tickets.company,
  tickets.email,tickets.phone,tickets.service,
  tickets.info,tickets.t_status
  FROM tickets
  INNER JOIN tasks ON tickets.id = tasks.t_id AND tasks.u_id=$u_id
...
<td align="center">
<a href="view.php?id=<?php echo (int)$data["id"]; ?>">View</a>
</td>
