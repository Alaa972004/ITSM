...
$database = new Connection();
  ...
  $query = "SELECT id,username,email,u_role FROM users WHERE u_role=90 OR u_role=80";
$result = $db->query($query);
 ...
 while($data = $result->fetch(PDO::FETCH_ASSOC)) {
   ...
   ?>
    <tr>
   <td><center>   <td><?php echo (int)$data['id']; ?> </td></center></td>
   <td><center><?php echo htmlspecialchars($data['username'], ENT_QUOTES, 'UTF-8'); ?> </center></td>
   <td><center><?php echo htmlspecialchars($data['email'], ENT_QUOTES, 'UTF-8'); ?> </center></td>
  <td><center><?php
if ($data['u_role'] == 90) {
 echo "Technical  Staff"; 
} else {
 echo "Team Leader"; 
}?> </center></td>

<td align="center"><center>
<a href="../includes/delete.inc.php?id=<?php echo (int)$data["id"]; ?>">Delete</a></center>
</td>
