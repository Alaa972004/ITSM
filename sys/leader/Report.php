...
$result = $db->query($query);
 ...
 while($data = $result->fetch(PDO::FETCH_ASSOC)) {
   ...
   ?>
    <tr>
  <td><center><?php echo $data['t_id']; ?> </center></td>
   <td><center><?php echo htmlspecialchars($data['details'], ENT_QUOTES, 'UTF-8'); ?> </center></td>
   <td><center><a href="<?php echo htmlspecialchars($data['file'], ENT_QUOTES, 'UTF-8'); ?> ">Download</a></center></td>
