...
<div class="login-block">
	<form action="includes/trace.inc.php" method="post" id="contact-form" class="form-inline contact_box">
    <h1>Trace Tickets</h1>
    <input type="text" placeholder="Enter Ticket Number..	" id="trace_number"  name="trace_number" required />
    <button type="submit" name='trace_t' >Check</button>
</div>
